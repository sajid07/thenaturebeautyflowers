  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        await fetchProduct({ category: 'cleaning product' }); // Include category filter for Pool Lights
  ...
  return (
    <>
      ...
      {loading ? ( // Show spinner when loading is true
        ...
        <h2 className="mb-4 text-center" style={{ color: 'red' }}>Cleaning Products</h2>
          <div className="row">
