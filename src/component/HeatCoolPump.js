  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        await fetchProduct({ category: 'heat cool pump' }); // Include category filter for Pool Lights
  ...
  return (
    <>
      ...
      {loading ? ( // Show spinner when loading is true
        ...
        <h2 className="mb-4 text-center" style={{ color: 'red' }}>Heat & Cool Pump</h2>
          <div className="row">
