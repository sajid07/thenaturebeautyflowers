        ...
        <Navbar.Collapse id="navbarCollapse">
          ...
          <Nav className="ms-auto">
            ...
            <NavDropdown title="Products">
              ...
              <NavDropdown.Item as={Link} to="/poolchemical">Pool Chemicals</NavDropdown.Item>
              <NavDropdown.Item as={Link} to="/waterfall">Waterfalls &Water  Curtains</NavDropdown.Item>
              <NavDropdown.Item as={Link} to="/intexpool">Intex Pool & Bestway</NavDropdown.Item>

              <NavDropdown.Item as={Link} to="/boosterpump">Booster Pumps</NavDropdown.Item>
            </NavDropdown>
