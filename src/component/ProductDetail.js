...
const ProductDetail = () => {
  ...
  const formattedDescription = productDescription ? productDescription.replace(/\n/g, '<br>') : '';
          ...
          <div style={contentStyle}>
            <div className="card text-center">
              ...
              <div className="card-body">
                ...
                />
                <div style={contentStyle}>
                  <p style={descriptionStyle} dangerouslySetInnerHTML={{ __html: formattedDescription }} />
                </div>
              </div>
              <div className="card-footer">
                ...
                <WhatsAppButton phoneNumber={contacts.whatsappContact} message={`Hi! Interested in ${product.name}. Could you share more details?`} />
              </div>
            </div>
          </div>
        </div>
